...
2. Организуйте файловую структуру проекта. _Пример_:
   ...
   ├── src/                            
   │   ├── Handlers/                   
   │   │   └── CreateRecipeHandler.php # Логика обработки формы добавления рецепта
...
1. Создайте в директории `src/Handlers/` файл `CreateRecipeHandler.php`, который будет обрабатывать данные формы.
